...
The **new Plotly version** (`cap3d_view_plotly.py`) provides a modern, interactive 3D visualization experience with enhanced features:
...
- `cap3d_view_plotly.py` - **Enhanced interactive version** (recommended)
- `cap3d_view.py` - Legacy matplotlib version
- `block_animation.py` - Block construction animation generator
- `*.cap3d` - CAP3D geometry files

## Legacy Version (Matplotlib)

The original version (`cap3d_view.py`) provides static 3D visualization using matplotlib:
